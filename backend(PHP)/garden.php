...
<div class="container my-5">
  <div class="row align-items-center p-4" 
    ...
    <div class="col-md-6">
      <h2 style="color:#87b890; font-weight:700;">
        Premium Garden Tools 🌿
      </h2>

      <p style="color:#cfe9d1; line-height:1.6;">
        Upgrade your gardening experience with high-quality tools designed for durability and comfort.
      </p>

      <ul style="color:#a8d5b5;">
        <li>✔ Rust-resistant materials</li>
        <li>✔ Ergonomic grip</li>
        <li>✔ Long-lasting performance</li>
      </ul>

      <button class="btn btn-success mt-3 px-4 py-2">Shop Now</button>
    </div>

    <div class="col-md-6 text-center">
      <img src="../images/tools.jpg" class="img-fluid rounded">
    </div>
...
$result = getFilteredProducts($conn, 'tools'); 
?>
 
<!--  -->
 <div class="container my-5">
  <div class="d-flex justify-content-between align-items-center mb-4">
    <h4 class="section-title">Garden Tools Collection 🌱</h4>
  </div>
...
<div class="container my-5 text-center">
  ...
  <h4 class="use-title">How to Use Garden Tools 🌿</h4>
  <p class="use-subtitle">Simple tips for better gardening</p>
  ...
  <div class="row mt-4 g-4">
    ...
    <div class="col-md-3">
      <div class="use-card">
        ...
        <h6>Prepare Soil</h6>
        <p>Loosen soil using tools for better plant growth</p>
      </div>
    </div>
    ...
    <div class="col-md-3">
      <div class="use-card">
        ...
        <h6>Trim Plants</h6>
        <p>Use pruners to remove dead leaves</p>
      </div>
    </div>
    ...
    <div class="col-md-3">
      <div class="use-card">
        <div class="use-icon">💧</div>
        <h6>Water Properly</h6>
        <p>Use watering cans for even watering</p>
      </div>
    </div>
    ...
    <div class="col-md-3">
      <div class="use-card">
        <div class="use-icon">🧤</div>
        <h6>Stay Safe</h6>
        <p>Wear gloves to protect your hands</p>
      </div>
    </div>
