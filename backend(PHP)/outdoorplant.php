...
.garden-box {
  min-width: 230px;
  flex-shrink: 0;
  background: linear-gradient(145deg, #e1d4c2, #d5c5b0);
  border-radius: 16px;
  padding: 20px 15px;
  text-align: center;
...
.garden-box::before {
  ...
  width: 200%;
  height: 200%;
  background: radial-gradient(circle, rgba(60,138,74,0.2), transparent 60%);
  opacity: 0;
  transition: 0.4s;
}

.garden-box:hover::before {
  opacity: 1;
}
...
<div class="page-banner text-center py-5 rounded" 
     style="background: url(../images/outdoorplants.jpg) no-repeat center center; 
  ...
  <div style="position: relative; z-index: 1;">
    <h1 class="fw-bold">Outdoor Plants</h1>
    <p>Perfect plants for your garden & balcony</p>
  </div>
</div>
<!-- filter  -->
 <?php include("filter_bar.php"); 
include("filter_query.php");  
$result = getFilteredProducts($conn, 'outdoor'); 
?>
 
<!--  -->
<div id="outdoor-products" class="product-section container my-5">
  <div class="row g-4">
    <?php
...
<div class="container my-5">
  <h4 style="color:#87b890;">Choose Your Garden Style</h4>

  <div class="garden-scroll mt-3">

    <div class="garden-box">
      <span class="icon">🌸</span>
      <h6>Flower Garden</h6>
      <p>Colorful blooming plants</p>
    </div>

    <div class="garden-box">
      <span class="icon">🌿</span>
      <h6>Minimal Garden</h6>
      <p>Clean & modern look</p>
    </div>

    <div class="garden-box">
      <span class="icon">🌴</span>
      <h6>Tropical Garden</h6>
      <p>Lush green vibe</p>
    </div>
    ...
    <div class="garden-box">
      <span class="icon">🌳</span>
      <h6>Big Plants</h6>
      <p>Trees & large plants</p>
    </div>

  </div>
</div>
<!-- befor/after -->
<div class="container my-5 text-center before-after">
  <h4 style="color:#87b890;">Transform Your Space</h4>
  <p>See how plants can completely change your outdoor area</p>

  <div class="row mt-4">
    <div class="col-md-6">
      <img src="../images/before.jpeg" 
     style="height:260px; width:100%; object-fit:cover; border-radius:12px;">
      <p class="mt-2">Before (Empty Balcony)</p>
    </div>

    <div class="col-md-6">
     <img src="../images/after.jpeg" 
     style="height:260px; width:100%; object-fit:cover; border-radius:12px;">
      <p class="mt-2">After (Green Setup)</p>
    </div>
  </div>
</div>
<!-- why outdoor -->
<div class="container my-5">
  <h4 style="color:#87b890;" class="text-center fw-bold">
  ...
  <div class="row mt-4 g-4">
    ...
    <div class="col-md-4">
      <div class="why-box">
        ...
        <h6>Fresh Air</h6>
        <p>Improves oxygen & environment</p>
      </div>
    </div>
    ...
    <div class="col-md-4">
      <div class="why-box">
        <div class="why-icon">🏡</div>
        <h6>Beautifies Space</h6>
        <p>Makes garden & balcony attractive</p>
      </div>
    </div>
...
<div class="text-center my-5">
  <h4>Transform Your Garden Today 🌿</h4>
 <a href="#outdoor-products">
  <button class="btn btn-success px-4 mt-2">Shop All Outdoor Plants</button>
</a>
</div>
