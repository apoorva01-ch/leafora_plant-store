  ...
  <div class="row align-items-center">
    ...
    <div class="col-md-6">
      ...
      <p style="color:#cfe9d1; font-size:1.1rem;">
        Start from seeds and watch your flowers bloom beautifully at home.
      </p>
    ...
    <div class="col-md-6 text-center">
      <img src="../images/grow.webp" alt="Seeds" class="img-fluid hero-img">
    </div>
  ...
  <div class="row mt-4 g-4">
    ...
    <div class="col-md-3">
      <div class="seed-category">
        ...
        <h6>Summer Flowers</h6>
        <p>Bright & heat-loving blooms</p>
      </div>
    </div>
    ...
    <div class="col-md-3">
      <div class="seed-category">
        <div class="seed-icon">🌼</div>
        <h6>Winter Flowers</h6>
        <p>Perfect for cool weather</p>
      </div>
    </div>
...
$result = getFilteredProducts($conn, 'flowerseed'); 
?>
...
<div class="container my-5 text-center steps-section">
  <h4 style="color:#87b890; font-weight:700;">How to Grow Seeds 🌱</h4>
